...
function setTime() {
    ...
    if(x == hours){
        ...
        image.style.backgroundImage = "url(./images/morning.svg)";
    }
    if(y == hours){
        ...
        let image = document.getElementById("alarmimage");
        image.style.backgroundImage = "url(./images/lunch.svg)";
    ...
    if(z == hours){
        ...
        let image = document.getElementById("alarmimage");
        image.style.backgroundImage = "url(./images/evening.png)";
